...
#1
def check_document_existance(user_doc_number):  #3t
    doc_founded = False
...
#4
def remove_doc_from_shelf(doc_number):  #2t
...
#5
def add_new_shelf(shelf_number=''): #2t
    if not shelf_number:
...
#6
def append_doc_to_shelf(doc_number, shelf_number): #2t
...
#10
def show_document_info(document):  #1
